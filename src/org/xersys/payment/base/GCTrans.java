...
public class GCTrans implements XPaymentInfo{
    ...
    public GCTrans(XNautilus foValue, String fsBranchCd, boolean fbWithParent){
        p_oNautilus = foValue;
        ...
        try {
            if (p_nEditMode == EditMode.ADDNEW){
                if (getItemCount() > 1){
                    ...
                    p_oDetail.last();                
                    if (String.valueOf(p_oDetail.getObject("sCompnyCd")).isEmpty() ||
                        String.valueOf(p_oDetail.getObject("sReferNox")).isEmpty() ||
                        p_oDetail.getObject("dValidity") == null ||
                        ((Number) p_oDetail.getObject("nAmountxx")).doubleValue() <= 0.00 ||
                        ((Number) p_oDetail.getObject("nAmtPaidx")).doubleValue() <= 0.00){
                ...
                for (int lnCtr = 1; lnCtr <= getItemCount(); lnCtr++){
                    p_oDetail.absolute(lnCtr);
                    p_oDetail.updateObject("sTransNox", MiscUtil.getNextCode("Gift_Certificate_Trans", "sTransNox", true, loConn, p_sBranchCd));
                    ...
                    lsSQL = MiscUtil.rowset2SQL(p_oDetail, "Gift_Certificate_Trans", "sCompnyNm");
                    ...
                    if(p_oNautilus.executeUpdate(lsSQL, "Gift_Certificate_Trans", p_sBranchCd, "") <= 0){
        ...
        try {
            ...
            switch (fsFieldNm){
                ...
                case "nAmtPaidx":
                    ...
                    break;
                case "sCompnyNm":
                    p_oDetail.updateObject(20, foValue);
                    p_oDetail.updateRow();
    ...
    private String getSQ_Detail(){
        return "SELECT" +
                    ...
                    ", a.dModified" +      
                    ", b.sCompnyNm" +
                " FROM Gift_Certificate_Trans a" +
                    " LEFT JOIN Affiliated_Company b ON a.sCompnyCd = b.sCompnyCd";
    }
